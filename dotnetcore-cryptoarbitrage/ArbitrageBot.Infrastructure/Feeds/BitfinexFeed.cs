...
public sealed class BitfinexFeed : IExchangeFeed, IDisposable
{
    ...
    OrderBook? ParseRest(string raw){try{var a=JArray.Parse(raw);if(a.Count<4)return null;return new(ExchangeId,(decimal)a[0],(decimal)a[2],(decimal)(a[1]??0),(decimal)(a[3]??0),DateTime.UtcNow);}catch{return null;}}
